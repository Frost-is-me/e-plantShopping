...
function ProductList({ onHomeClick }) {
    ...
    const handleAddToCart = (proudct) => {
        const cost = typeof proudct.cost === 'string' ? proudct.cost.replace('$', '') : proudct.cost;
        dispatch(addItem({ ...proudct, cost }));
                                ...
                                {category.plants.map((plant,index) => {
                                  ...
                                  return (
                                    <div className='product-card' key={index}>
                                        ...
                                        <div product-cost>{plant.cost}</div>
                                      <button
